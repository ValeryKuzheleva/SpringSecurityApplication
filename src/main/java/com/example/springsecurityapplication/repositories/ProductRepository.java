...
public interface ProductRepository extends JpaRepository<Product, Integer> {
    ...
    //Сортировка товаров по цене от и до
    @Query(value = "select * from product where price >= ?2 and price <= ?3", nativeQuery = true)
    List<Product> findByOtAndDo(float ot, float Do);

    //Поиск по наимениованию и фильтрация по диапазону цены
    ...
    //Поиск по наимениованию и фильтрация по диапазону цены,а также сортировка по возрастанию цены
    ...
    //Поиск по наимениованию и фильтрация по диапазону цены, сортировка по возрастанию цены,а также фильтрация по категории
    ...
    //Поиск по наимениованию и фильтрация по диапазону цены, сортировка по убыванию цены,а также фильтрация по категории
